  ...
  const categories = [
    {
      ...
      icon: <Code2 size={28} />,
      skills: ["React.js", "Node.js", "Express.js", "Next.js", "TypeScript", "Tailwind", "MongoDB", "REST APIs"],
      color: "text-[#61dafb]",
    },
    {
      title: "Machine Learning",
      icon: <Activity size={28} />,
      skills: ["Supervised Learning", "Unsupervised Learning", "Computer Vision", "Feature Engineering"],
      color: "text-[#38ffbc]",
    },
    {
      title: "Data Analysis",
    ...
    },
    {
      title: "Deep Learning",
      icon: <Bot size={28} />,
      skills: ["TensorFlow", "Keras", "CNNs", "RNNs", "Large Language Models", "Architectural Design"],
      color: "text-[#00af99]",
    },
    {
      title: "IoT & Embedded",
    ...
    },
    {
      ...
      icon: <Wrench size={28} />,
      skills: ["Postman", "Deployment Tools", "Vertex", "Google Cloud", "Looker", "Firebase"],
      color: "text-white",
    },
  ];
          ...
          {categories.map((cat) => (
            <motion.div
              ...
              className="bg-[#111] border border-[#222] 
                         ...
                         transition-all" style={{ padding: "2rem 0.2rem", borderRadius: "2rem", }}
            >
              {/* Header: Icon + Title */}
              <div className={`flex flex-col items-center mb-24 text-4xl font-bold ${cat.color}`} style={{ padding: "1rem 0" }}>
